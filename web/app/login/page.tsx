  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f1f5f9", padding: 16 }}>
      <div style={{ background: "white", padding: 32, borderRadius: 24, width: 380, border: "1px solid #e2e8f0" }}>
        ...
        {/* EE LOGO - CLEAR - BLACK BG */}
        <div style={{ width: 130, height: 80, background: "black", borderRadius: 16, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <img src="/logo.png" alt="logo" style={{ width: "92%", height: "92%", objectFit: "contain" }} />
        </div>
        ...
        {step === 1 ? (
          ...
          <>
            <input value={otp} onChange={e => setOtp(e.target.value)} placeholder="123456" maxLength={6} style={{ width: "100%", padding: 13, borderRadius: 12, border: "1px solid #d0d7e2", textAlign: "center", letterSpacing: 6, fontWeight: 700 }}/>
